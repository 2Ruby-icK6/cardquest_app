    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('card_type', models.CharField(blank=True, choices=[('Fire', 'Fire'), ('Water', 'Water'), ('Grass', 'Grass'), ('Electric', 'Electric'), ('Psychic', 'Psychic'), ('Ice', 'Ice'), ('Dragon', 'Dragon'), ('Dark', 'Dark'), ('Fighting', 'Fighting'), ('Flying', 'Flying'), ('Posion', 'Posion'), ('Ground', 'Ground'), ('Rock', 'Rock'), ('Bug', 'BUg'), ('Ghost', 'Ghost'), ('Steel', 'Steel'), ('Fairy', 'Fairy')], max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Trainer', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='cardquest.trainer')),
